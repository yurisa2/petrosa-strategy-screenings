...
def calc_screening(candles, periods):
    ...
    if(close < ema8
        ...
        print(high, dat.high.iloc[-2])
        print(low, dat.low.iloc[-2])
...
def entrypoint(request):
    ...
    try:
        ...
        if(result):
            ...
            new_line['movement'] = ''
            new_line['screening_type'] = 22
            new_line['screening_name'] = 'VENDA POR INSIDE BAR'
            new_line['disruption_value'] = result['disruption_value']
            new_line['direction'] = result['direction']
